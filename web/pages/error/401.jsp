...
<head>
    ...
    <title>401 - Unauthorised | ProcureGov</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .error-code { font-size: 6rem; font-weight: 700; color: #C9A227; line-height: 1; margin-bottom: 8px; }
        .error-title { font-size: 1.5rem; font-weight: 600; color: #A6851E; margin-bottom: 12px; }
...
<body>
    <div class="error-container">
        ...
        <div class="error-title">Unauthorised Access</div>
        <div class="error-divider"></div>
        <p class="error-message">You must be logged in to access this resource. Please sign in with your ProcureGov credentials and try again.</p>
        <a href="${pageContext.request.contextPath}/login" class="btn-home">Sign In</a>
    </div>
</body>
</html>
