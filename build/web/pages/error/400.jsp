...
<head>
    ...
    <title>400 - Bad Request | ProcureGov</title>
    <style>
...
<body>
    <div class="error-container">
        ...
        <p class="error-message">The server could not understand your request. Please verify the information entered and try again.</p>
