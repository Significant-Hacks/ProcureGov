...
<head>
    ...
    <title>404 - Page Not Found | ProcureGov</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .error-code { font-size: 6rem; font-weight: 700; color: #1B4332; line-height: 1; margin-bottom: 8px; }
        .error-title { font-size: 1.5rem; font-weight: 600; color: #2D6A4F; margin-bottom: 12px; }
...
<body>
    <div class="error-container">
        ...
        <p class="error-message">The page you are looking for does not exist or has been moved. Please check the URL or return to the ProcureGov portal homepage.</p>
