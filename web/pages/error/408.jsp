...
<head>
    ...
    <title>408 - Request Timeout | ProcureGov</title>
    <style>
...
<body>
    <div class="error-container">
        ...
        <p class="error-message">Your request took too long to process. This may be due to a slow connection or server load. Please try again.</p>
