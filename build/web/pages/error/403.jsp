...
<head>
    ...
    <title>403 - Access Denied | ProcureGov</title>
    <style>
...
<body>
    <div class="error-container">
        ...
        <p class="error-message">You do not have permission to access this resource. This area is restricted to authorised personnel only. If you believe this is an error, contact the ICT Directorate.</p>
